 ...
 */
function isPlanetHabitable(coordinates) {
 ...
 */
function solvePlanet() {
    const inputElement = document.getElementById('coordinates');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const coordinatesInput = document.getElementById('coordinates');
    if (!solveBtn)
        console.warn('Botão "solveBtn" não encontrado!');
    if (!resetBtn)
        console.warn('Botão "resetBtn" não encontrado!');
    if (!coordinatesInput)
        console.warn('Campo "coordinates" não encontrado!');
    if (solveBtn)
        solveBtn.addEventListener('click', solvePlanet);
    if (resetBtn)
